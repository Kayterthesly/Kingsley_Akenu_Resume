...
- **Project B:** Creating an interactive energy usage dashboard in Power BI.
- **Content Creation:** Developing new workflow optimization on data visualization for my Linkedin article.

## 🌱 Currently Learning 

- Advanced machine learning techniques in Scikit-learn.
- Big Data optimization with SQL.
